...
class StylesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create style" do
    assert_difference("Style.count") do
      post styles_url, params: { style: { comment: @style.comment, css: @style.css, museum_id: @style.museum_id, name: @style.name } }
    end
  ...
  test "should update style" do
    patch style_url(@style), params: { style: { comment: @style.comment, css: @style.css, museum_id: @style.museum_id, name: @style.name } }
